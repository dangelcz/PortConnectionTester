...
public class Reflection
{
	...
	public static String fieldNameByAnnotation(Class<?> objectClass, Class<?> superParentClass, Class<? extends Annotation> annotation)
	{
		Field f = null;
		try
		{
			f = findFieldWithAnnotation(objectClass, superParentClass, annotation);
		} catch (Exception e)
		{
			e.printStackTrace();
		}
	...
	public static Field findFieldBy(Class<?> objectClass, Class<?> superParentClass, Object criteriaObject, FieldCriteria criteria)
	{
		...
		if (objectClass.getSimpleName().equalsIgnoreCase(superParentClass.getName()))
		{
	...
	public static boolean hasParentClass(Class<?> testedClass, Class<?> expectedParent)
	{
		if (!compareClasses(testedClass, expectedParent))
		{
			...
			if (compareClasses(parentClass, Object.class))
			{
				return false;
			}
	...
	public static void setStaticFieldValue(Class<?> classInstance, String fieldName, Object value) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException
	{
	...
	public static void fieldsToHashMap(Object object, Class<?> objClass, String superParentName, HashMap<String, Object> data) throws IllegalArgumentException, IllegalAccessException
	{
		Class<?> parent = objClass.getSuperclass();
	...
	public static Object getStaticFieldValue(Class<?> classInstance, String fieldName) throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException
	{
