...
public class PackageReflection
{
	...
	public static List<Class<?>> getClassesOfPackage(String packageName, ClassCriteria criteria, Object criteriaObject)
	{
	...
	private static List<String> getClassNamesOfPackage(String packageName)
	{
